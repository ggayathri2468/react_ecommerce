  ...
  return (
    <div className="orderdetail">
      <div className="Orderdeail_div">
        <div className="box" style={{position:"relative", height:"100px", marginBottom:"15px"}} >
        ...
        <div className="box">
          <div className="flexs">
            ...
            <span ><b>#{orderlist.products[0].id}</b></span>
          </div>
          <div className="flexs">
            <span className="graycolor">Date</span>
            <span ><b>{orderlist.products[0].date}</b></span>
          ...
          >
            ...
            <div>
              ...
              {(() => {
                ...
                const count = Number(orderlist.products[0].count);
            ...
            <hr />
          <div className="flexs">
            <span className="graycolor">Subtotal</span>
            <span >
             <b>
              <i
                className="fa-solid fa-indian-rupee-sign"
              ...
              {(() => {
                ...
                const count = Number(orderlist.products[0].count);
                return !isNaN(cleanedPrice) && count ? cleanedPrice + 89 : 0;
              })()}</b>
            </span>
          </div>
          <div className="flexs">
        ...
        <div  className="box">
            <div><b>Customer information</b></div>
                ...
                <div>
                    ...
                    <div><span>Cash on delivery</span><span style={{color:"rebeccapurple" ,fontWeight:"500"}}>-Rs.{orderlist.products[0].price}</span></div>
                </div>
